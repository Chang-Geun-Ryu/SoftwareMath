...
namespace Lab7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<int> sortKeys = FilterEngine.GetSortKeys(frames, 
            new List<EFeatureFlags> { EFeatureFlags.Aviator, EFeatureFlags.Men, EFeatureFlags.Rectangle, EFeatureFlags.Red });
